...
## 1. プロジェクト概要
### 1-1. プロジェクト名
**秀歌 - Shuka（AI音楽アーティスト公式サイト）**

### 1-2. 目的・目標
- AI音楽アーティスト「秀歌 - Shuka」の公式Webサイト制作 ✅
- **Vibe Cording** の魅力と可能性をターゲットユーザーに伝える ✅
- 訪問者に驚きと印象的な体験を提供する ✅

### 1-3. 現在の状況
（運用メモ）本書は現行の運用ガイドです。過度な進捗表現は避け、常に最新の方針に合わせて更新します。
...
#### 5-1-1. 季節演出システム（方針）
- 背景和紙の季節自動切替（運用方針）
- 雨滴演出（既存）。その他（桜/柳/紅葉/雪 など）は将来候補として検討
- 切り替え方式は自動検知を基本とし、必要に応じて手動切替も検討
